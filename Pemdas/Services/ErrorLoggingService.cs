...
/// <summary>
/// Centralized error logging and handling service with detailed diagnostics for Pemdas
/// </summary>
public class ErrorLoggingService
{
    ...
    {
        _logFilePath = Path.Combine(FileSystem.AppDataDirectory, "pemdas_error_log.txt");
    }
