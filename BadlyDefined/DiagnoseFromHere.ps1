Write-Host "🔍 COMPREHENSIVE CRASH DIAGNOSIS (Run from BadlyDefined folder)" -ForegroundColor Cyan
...
Write-Host "   4. Clear the output (right-click → Clear All)" -ForegroundColor White
Write-Host ""
...
Write-Host ""
Write-Host "The LAST 🔧 message before crash shows where it failed!" -ForegroundColor Cyan
